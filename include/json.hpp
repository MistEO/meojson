...
public:
    ...
    template <typename value_t, template <typename _T> typename vector_t = std::vector>
    vector_t<value_t> to_vector() const;
    template <typename value_t, template <typename _K, typename _T> typename map_t = std::map>
...
template <typename string_t>
template <typename value_t, template <typename _K, typename _T> typename map_t>
