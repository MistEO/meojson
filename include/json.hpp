...
{
    template <typename... _>
    using map_t = std::map<_...>;
    template <typename... _>
    using unique_ptr_t = std::unique_ptr<_...>;
    template <typename... _>
    using variant_t = std::variant<_...>;
};

#ifdef __json_enable_constexpr
struct constexpr_container_traits
{
    template <typename... _>
    using map_t = constexpr_map<_...>;
    template <typename... _>
    using unique_ptr_t = constexpr_unique_ptr<_...>;
    template <typename... _>
    using variant_t = constexpr_variant<_...>;
};
#endif
...
using value = basic_value<default_string_t, default_container_traits>;
using array = basic_array<default_string_t, default_container_traits>;
using object = basic_object<default_string_t, default_container_traits>;

using wvalue = basic_value<std::wstring, default_container_traits>;
using warray = basic_array<std::wstring, default_container_traits>;
using wobject = basic_object<std::wstring, default_container_traits>;

#ifdef __json_enable_constexpr

using cvalue = basic_value<default_string_t, constexpr_container_traits>;
using carray = basic_array<default_string_t, constexpr_container_traits>;
using cobject = basic_object<default_string_t, constexpr_container_traits>;
...
class basic_value
{
    using array_ptr = typename traits_t::template unique_ptr_t<basic_array<string_t, traits_t>>;
    using object_ptr = typename traits_t::template unique_ptr_t<basic_object<string_t, traits_t>>;
...
public:
    ...
    using var_t = typename traits_t::template variant_t<string_t, array_ptr, object_ptr>;
    using char_t = typename string_t::value_type;

public:
    __json_constexpr basic_value();
    __json_constexpr basic_value(const basic_value<string_t, traits_t>& rhs);
    __json_constexpr basic_value(basic_value<string_t, traits_t>&& rhs) noexcept;
    ...
    template <typename collection_t,
              std::enable_if_t<std::is_constructible_v<typename basic_array<string_t, traits_t>::value_type,
                                                       utils::range_value_t<collection_t>>,
                               bool> = true>
    __json_constexpr basic_value(collection_t&& collection)
        : basic_value(basic_array<string_t, traits_t>(std::forward<collection_t>(collection)))
    {}
    template <typename another_map_t,
              std::enable_if_t<std::is_constructible_v<typename basic_object<string_t, traits_t>::value_type,
                                                       utils::range_value_t<another_map_t>>,
                               bool> = true>
    __json_constexpr basic_value(another_map_t&& map)
        : basic_value(basic_object<string_t, traits_t>(std::forward<another_map_t>(map)))
    {}

    template <typename value_t,
              std::enable_if_t<!std::is_convertible_v<value_t, basic_value<string_t, traits_t>>, bool> = true>
    ...
    __json_constexpr const basic_value<string_t, traits_t>& at(size_t pos) const;
    __json_constexpr const basic_value<string_t, traits_t>& at(const string_t& key) const;
    ...
    template <typename value_t = basic_value<string_t, traits_t>>
    ...
    __json_constexpr const basic_array<string_t, traits_t>& as_array() const;
    __json_constexpr const basic_object<string_t, traits_t>& as_object() const;
    template <typename value_t>
    __json_constexpr value_t as() const;

    __json_constexpr basic_array<string_t, traits_t>& as_array();
    __json_constexpr basic_object<string_t, traits_t>& as_object();
    ...
    __json_constexpr basic_value<string_t, traits_t>& operator=(const basic_value<string_t, traits_t>& rhs);
    __json_constexpr basic_value<string_t, traits_t>& operator=(basic_value<string_t, traits_t>&&) noexcept;

    __json_constexpr bool operator==(const basic_value<string_t, traits_t>& rhs) const;
    __json_constexpr bool operator!=(const basic_value<string_t, traits_t>& rhs) const { return !(*this == rhs); }

    __json_constexpr const basic_value<string_t, traits_t>& operator[](size_t pos) const;
    __json_constexpr basic_value<string_t, traits_t>& operator[](size_t pos);
    __json_constexpr basic_value<string_t, traits_t>& operator[](const string_t& key);
    __json_constexpr basic_value<string_t, traits_t>& operator[](string_t&& key);

    __json_constexpr basic_value<string_t, traits_t> operator|(const basic_object<string_t, traits_t>& rhs) const&;
    __json_constexpr basic_value<string_t, traits_t> operator|(basic_object<string_t, traits_t>&& rhs) const&;
    __json_constexpr basic_value<string_t, traits_t> operator|(const basic_object<string_t, traits_t>& rhs) &&;
    __json_constexpr basic_value<string_t, traits_t> operator|(basic_object<string_t, traits_t>&& rhs) &&;

    __json_constexpr basic_value<string_t, traits_t>& operator|=(const basic_object<string_t, traits_t>& rhs);
    __json_constexpr basic_value<string_t, traits_t>& operator|=(basic_object<string_t, traits_t>&& rhs);

    __json_constexpr basic_value<string_t, traits_t> operator+(const basic_array<string_t, traits_t>& rhs) const&;
    __json_constexpr basic_value<string_t, traits_t> operator+(basic_array<string_t, traits_t>&& rhs) const&;
    __json_constexpr basic_value<string_t, traits_t> operator+(const basic_array<string_t, traits_t>& rhs) &&;
    __json_constexpr basic_value<string_t, traits_t> operator+(basic_array<string_t, traits_t>&& rhs) &&;
...
private:
    friend class basic_array<string_t, traits_t>;
    friend class basic_object<string_t, traits_t>;
...
class basic_array
{
    friend class basic_value<string_t, traits_t>;
    friend class basic_object<string_t, traits_t>;

public:
    using raw_array = std::vector<basic_value<string_t, traits_t>>;
...
public:
    ...
    __json_constexpr basic_array(const basic_array<string_t, traits_t>& rhs) = default;
    __json_constexpr basic_array(basic_array<string_t, traits_t>&& rhs) noexcept = default;
    ...
    __json_constexpr explicit basic_array(const basic_value<string_t, traits_t>& val);
    __json_constexpr explicit basic_array(basic_value<string_t, traits_t>&& val);
    ...
    __json_constexpr basic_array<string_t, traits_t> operator+(const basic_array<string_t, traits_t>& rhs) const&;
    __json_constexpr basic_array<string_t, traits_t> operator+(basic_array<string_t, traits_t>&& rhs) const&;
    __json_constexpr basic_array<string_t, traits_t> operator+(const basic_array<string_t, traits_t>& rhs) &&;
    __json_constexpr basic_array<string_t, traits_t> operator+(basic_array<string_t, traits_t>&& rhs) &&;

    __json_constexpr basic_array<string_t, traits_t>& operator+=(const basic_array<string_t, traits_t>& rhs);
    __json_constexpr basic_array<string_t, traits_t>& operator+=(basic_array<string_t, traits_t>&& rhs);

    __json_constexpr basic_array<string_t, traits_t>& operator=(const basic_array<string_t, traits_t>&) = default;
    __json_constexpr basic_array<string_t, traits_t>& operator=(basic_array<string_t, traits_t>&&) noexcept = default;

    __json_constexpr bool operator==(const basic_array<string_t, traits_t>& rhs) const;
    __json_constexpr bool operator!=(const basic_array<string_t, traits_t>& rhs) const { return !(*this == rhs); }
...
public:
    using raw_object = typename traits_t::template map_t<string_t, basic_value<string_t, traits_t>>;
...
public:
    ...
    __json_constexpr basic_object(const basic_object<string_t, traits_t>& rhs) = default;
    __json_constexpr basic_object(basic_object<string_t, traits_t>&& rhs) noexcept = default;
    __json_constexpr basic_object(std::initializer_list<value_type> init_list);
    __json_constexpr explicit basic_object(const basic_value<string_t, traits_t>& val);
    __json_constexpr explicit basic_object(basic_value<string_t, traits_t>&& val);
    template <typename another_map_t,
    ...
    __json_constexpr basic_object<string_t, traits_t> operator|(const basic_object<string_t, traits_t>& rhs) const&;
    __json_constexpr basic_object<string_t, traits_t> operator|(basic_object<string_t, traits_t>&& rhs) const&;
    __json_constexpr basic_object<string_t, traits_t> operator|(const basic_object<string_t, traits_t>& rhs) &&;
    __json_constexpr basic_object<string_t, traits_t> operator|(basic_object<string_t, traits_t>&& rhs) &&;

    __json_constexpr basic_object<string_t, traits_t>& operator|=(const basic_object<string_t, traits_t>& rhs);
    __json_constexpr basic_object<string_t, traits_t>& operator|=(basic_object<string_t, traits_t>&& rhs);

    __json_constexpr basic_object<string_t, traits_t>& operator=(const basic_object<string_t, traits_t>&) = default;
    __json_constexpr basic_object<string_t, traits_t>& operator=(basic_object<string_t, traits_t>&&) = default;

    __json_constexpr bool operator==(const basic_object<string_t, traits_t>& rhs) const;
    __json_constexpr bool operator!=(const basic_object<string_t, traits_t>& rhs) const { return !(*this == rhs); }
...
template <typename string_t = default_string_t, typename traits_t = default_container_traits, typename parsing_t = void,
...
public:
    ...
    __json_constexpr static std::optional<basic_value<string_t, traits_t>> parse(const parsing_t& content);

private:
    __json_constexpr parser(parsing_iter_t cbegin, parsing_iter_t cend) noexcept : _cur(cbegin), _end(cend) { ; }

    __json_constexpr std::optional<basic_value<string_t, traits_t>> parse();
    __json_constexpr basic_value<string_t, traits_t> parse_value();

    __json_constexpr basic_value<string_t, traits_t> parse_null();
    __json_constexpr basic_value<string_t, traits_t> parse_boolean();
    __json_constexpr basic_value<string_t, traits_t> parse_number();
    // parse and return a basic_value<string_t, traits_t> whose type is value_type::string
    __json_constexpr basic_value<string_t, traits_t> parse_string();
    __json_constexpr basic_value<string_t, traits_t> parse_array();
    __json_constexpr basic_value<string_t, traits_t> parse_object();
...
template <typename string_t = default_string_t, typename traits_t = default_container_traits>
__json_constexpr const basic_value<string_t, traits_t> invalid_value();
...
template <bool loose, typename any_t, typename string_t = default_string_t,
          typename traits_t = default_container_traits,
          typename string_converter_t = _serialization_helper::string_converter<loose, string_t>>
__json_constexpr basic_value<string_t, traits_t> serialize(any_t&& arg, string_converter_t&& string_converter = {});
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value() = default;

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(const basic_value<string_t, traits_t>& rhs)
    : _type(rhs._type), _raw_data(deep_copy(rhs._raw_data))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(basic_value<string_t, traits_t>&& rhs) noexcept =
    default;

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(bool b)
    : _type(value_type::boolean), _raw_data(string_t(b ? true_string<string_t>() : false_string<string_t>()))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(int num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(unsigned num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(long num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(unsigned long num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(long long num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(unsigned long long num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(float num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(double num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(long double num)
    : _type(value_type::number), _raw_data(to_basic_string<string_t>(num))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(const char_t* str)
    : _type(value_type::string), _raw_data(string_t(str))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(string_t str)
    : _type(value_type::string), _raw_data(std::move(str))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(basic_array<string_t, traits_t> arr)
    : _type(value_type::array), _raw_data(typename traits_t::template unique_ptr_t<basic_array<string_t, traits_t>>(
                                    new basic_array<string_t, traits_t>(std::move(arr))))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(basic_object<string_t, traits_t> obj)
    : _type(value_type::object), _raw_data(typename traits_t::template unique_ptr_t<basic_object<string_t, traits_t>>(
                                     new basic_object<string_t, traits_t>(std::move(obj))))
{}
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::is() const noexcept
{
    if constexpr (std::is_same_v<basic_value<string_t, traits_t>, value_t>) {
        return true;
    }
    ...
    else if constexpr (std::is_same_v<basic_array<string_t, traits_t>, value_t>) {
        return _type == value_type::array;
    }
    else if constexpr (std::is_same_v<basic_object<string_t, traits_t>, value_t>) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::contains(const string_t& key) const
{
    return is_object() && as_object().contains(key);
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::contains(size_t pos) const
{
    return is_array() && as_array().contains(pos);
}

template <typename string_t, typename traits_t>
inline __json_constexpr const basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::at(size_t pos) const
{
    return as_array().at(pos);
}

template <typename string_t, typename traits_t>
inline __json_constexpr const basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::at(
...
template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::erase(size_t pos)
{
    return as_array().erase(pos);
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::erase(const string_t& key)
{
...
template <typename string_t, typename traits_t>
template <typename... key_then_default_value_t>
inline __json_constexpr auto basic_value<string_t, traits_t>::get(
...
template <typename string_t, typename traits_t>
template <typename value_t, typename first_key_t, typename... rest_keys_t>
inline __json_constexpr auto basic_value<string_t, traits_t>::get_helper(const value_t& default_value,
                                                                         first_key_t&& first,
...
template <typename string_t, typename traits_t>
template <typename... key_then_default_value_t>
inline __json_constexpr auto basic_array<string_t, traits_t>::get(
    key_then_default_value_t&&... keys_then_default_value) const
{
    return get(std::forward_as_tuple(keys_then_default_value...),
               std::make_index_sequence<sizeof...(keys_then_default_value) - 1> {});
...
template <typename string_t, typename traits_t>
template <typename... key_then_default_value_t>
inline __json_constexpr auto basic_object<string_t, traits_t>::get(
    key_then_default_value_t&&... keys_then_default_value) const
{
    return get(std::forward_as_tuple(keys_then_default_value...),
               std::make_index_sequence<sizeof...(keys_then_default_value) - 1> {});
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr std::optional<value_t> basic_value<string_t, traits_t>::find(size_t pos) const
{
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr std::optional<value_t> basic_value<string_t, traits_t>::find(const string_t& key) const
{
    return is_object() ? as_object().template find<value_t>(key) : std::nullopt;
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::as_boolean() const
{
    if (is_boolean()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr int basic_value<string_t, traits_t>::as_integer() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr unsigned basic_value<string_t, traits_t>::as_unsigned() const
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr long basic_value<string_t, traits_t>::as_long() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr unsigned long basic_value<string_t, traits_t>::as_unsigned_long() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr long long basic_value<string_t, traits_t>::as_long_long() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr unsigned long long basic_value<string_t, traits_t>::as_unsigned_long_long() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr float basic_value<string_t, traits_t>::as_float() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr double basic_value<string_t, traits_t>::as_double() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr long double basic_value<string_t, traits_t>::as_long_double() const
{
    if (is_number()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_value<string_t, traits_t>::as_string() const
{
    if (is_string()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr const basic_array<string_t, traits_t>& basic_value<string_t, traits_t>::as_array() const
{
    if (is_array()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr const basic_object<string_t, traits_t>& basic_value<string_t, traits_t>::as_object() const
{
    if (is_object()) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_array<string_t, traits_t>& basic_value<string_t, traits_t>::as_array()
{
    if (empty()) {
        *this = basic_array<string_t, traits_t>();
    }
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_object<string_t, traits_t>& basic_value<string_t, traits_t>::as_object()
{
    if (empty()) {
        *this = basic_object<string_t, traits_t>();
    }
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr value_t basic_value<string_t, traits_t>::as() const
{
    return static_cast<value_t>(*this);
}

template <typename string_t, typename traits_t>
inline __json_constexpr const string_t& basic_value<string_t, traits_t>::as_basic_type_str() const
{
    return std::get<string_t>(_raw_data);
}

template <typename string_t, typename traits_t>
inline __json_constexpr string_t& basic_value<string_t, traits_t>::as_basic_type_str()
{
    return std::get<string_t>(_raw_data);
}
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_value<string_t, traits_t>::emplace(args_t&&... args)
{
    constexpr bool is_array_args =
        std::is_constructible_v<typename basic_array<string_t, traits_t>::value_type, args_t...>;
    constexpr bool is_object_args =
        std::is_constructible_v<typename basic_object<string_t, traits_t>::value_type, args_t...>;
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_value<string_t, traits_t>::array_emplace(args_t&&... args)
{
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_value<string_t, traits_t>::object_emplace(args_t&&... args)
{
    return emplace(std::forward<args_t>(args)...);
}

template <typename string_t, typename traits_t>
inline __json_constexpr void basic_value<string_t, traits_t>::clear() noexcept
{
    *this = basic_value<string_t, traits_t>();
}

template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_value<string_t, traits_t>::to_string() const
{
    switch (_type) {
...
template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_value<string_t, traits_t>::format(size_t indent, size_t indent_times) const
{
    switch (_type) {
    case value_type::null:
    case value_type::boolean:
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::all() const
{
    if (is_array()) {
...
inline __json_constexpr vector_t<value_t> basic_value<string_t, traits_t>::to_vector() const
{
...
inline __json_constexpr another_map_t<string_t, value_t> basic_value<string_t, traits_t>::to_map() const
{
    return as_object().template to_map<value_t, another_map_t>();
}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::operator=(
    const basic_value<string_t, traits_t>& rhs)
{
    _type = rhs._type;
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::operator=(
    basic_value<string_t, traits_t>&& rhs) noexcept = default;

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_value<string_t, traits_t>::operator==(
    const basic_value<string_t, traits_t>& rhs) const
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr const basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::operator[](
    size_t pos) const
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::operator[](size_t pos)
{
    // basic_array not support to create by operator[]
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_value<string_t, traits_t>::operator[](string_t&& key)
{
    if (empty()) {
        *this = basic_object<string_t, traits_t>();
    }
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator|(
    const basic_object<string_t, traits_t>& rhs) const&
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator|(
    basic_object<string_t, traits_t>&& rhs) const&
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator|(
    const basic_object<string_t, traits_t>& rhs) &&
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator|(
    basic_object<string_t, traits_t>&& rhs) &&
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator+(
    const basic_array<string_t, traits_t>& rhs) const&
{
    return as_array() + rhs;
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator+(
    basic_array<string_t, traits_t>&& rhs) const&
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator+(
    const basic_array<string_t, traits_t>& rhs) &&
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t> basic_value<string_t, traits_t>::operator+(
    basic_array<string_t, traits_t>&& rhs) &&
{
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr basic_value<string_t, traits_t>::basic_value(value_type type, args_t&&... args)
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_value<string_t, traits_t>::var_t basic_value<string_t, traits_t>::deep_copy(
    const var_t& src)
{
    var_t dst;
    if (const auto string_ptr = std::get_if<string_t>(&src)) {
        ...
        dst = typename traits_t::template unique_ptr_t<basic_array<string_t, traits_t>>(
            new basic_array<string_t, traits_t>(**arr_ptr));
    }
    else if (const auto obj_ptr = std::get_if<object_ptr>(&src)) {
        dst = typename traits_t::template unique_ptr_t<basic_object<string_t, traits_t>>(
            new basic_object<string_t, traits_t>(**obj_ptr));
    }
    else {
        // maybe invalid_value
    }
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_array<string_t, traits_t>::basic_array(std::initializer_list<value_type> init_list)
    : _array_data(init_list)
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_array<string_t, traits_t>::basic_array(typename raw_array::size_type size)
    : _array_data(size)
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_array<string_t, traits_t>::basic_array(const basic_value<string_t, traits_t>& val)
    : basic_array<string_t, traits_t>(val.as_array())
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_array<string_t, traits_t>::basic_array(basic_value<string_t, traits_t>&& val)
    : basic_array<string_t, traits_t>(std::move(val.as_array()))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr void basic_array<string_t, traits_t>::clear() noexcept
{
    _array_data.clear();
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_array<string_t, traits_t>::erase(size_t pos)
{
    return erase(_array_data.begin() + pos);
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_array<string_t, traits_t>::erase(iterator iter)
{
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_array<string_t, traits_t>::emplace_back(args_t&&... args)
{
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_array<string_t, traits_t>::push_back(args_t&&... args)
{
    return emplace_back(std::forward<args_t>(args)...);
}

template <typename string_t, typename traits_t>
inline __json_constexpr const basic_value<string_t, traits_t>& basic_array<string_t, traits_t>::at(size_t pos) const
{
    return _array_data.at(pos);
}

template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_array<string_t, traits_t>::to_string() const
{
    string_t str { '[' };
...
template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_array<string_t, traits_t>::format(size_t indent, size_t indent_times) const
{
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr bool basic_array<string_t, traits_t>::all() const
{
...
template <typename string_t, typename traits_t>
template <typename value_t, template <typename...> typename vector_t>
inline __json_constexpr vector_t<value_t> basic_array<string_t, traits_t>::to_vector() const
{
...
template <typename string_t, typename traits_t>
template <typename value_t, typename... rest_keys_t>
inline __json_constexpr auto basic_array<string_t, traits_t>::get_helper(const value_t& default_value, size_t pos,
                                                                         rest_keys_t&&... rest) const
{
    constexpr bool is_json = std::is_same_v<basic_value<string_t, traits_t>, value_t> ||
                             std::is_same_v<basic_array<string_t, traits_t>, value_t> ||
                             std::is_same_v<basic_object<string_t, traits_t>, value_t>;
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr auto basic_array<string_t, traits_t>::get_helper(const value_t& default_value, size_t pos) const
{
    constexpr bool is_json = std::is_same_v<basic_value<string_t, traits_t>, value_t> ||
                             std::is_same_v<basic_array<string_t, traits_t>, value_t> ||
                             std::is_same_v<basic_object<string_t, traits_t>, value_t>;
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr std::optional<value_t> basic_array<string_t, traits_t>::find(size_t pos) const
{
    static_assert(std::is_constructible_v<value_t, basic_value<string_t, traits_t>>,
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::iterator basic_array<string_t,
                                                                                       traits_t>::begin() noexcept
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::iterator basic_array<string_t,
                                                                                       traits_t>::end() noexcept
{
    return _array_data.end();
}

template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_iterator basic_array<
    string_t, traits_t>::begin() const noexcept
{
    return _array_data.begin();
}

template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_iterator basic_array<string_t, traits_t>::end()
    const noexcept
{
    return _array_data.end();
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_iterator basic_array<
    string_t, traits_t>::cbegin() const noexcept
{
    return _array_data.cbegin();
}

template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_iterator basic_array<string_t, traits_t>::cend()
    const noexcept
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::reverse_iterator basic_array<
    string_t, traits_t>::rbegin() noexcept
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::reverse_iterator basic_array<
    string_t, traits_t>::rend() noexcept
{
    return _array_data.rend();
}

template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_reverse_iterator basic_array<
    string_t, traits_t>::rbegin() const noexcept
{
    return _array_data.rbegin();
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_reverse_iterator basic_array<
    string_t, traits_t>::rend() const noexcept
{
    return _array_data.rend();
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_reverse_iterator basic_array<
    string_t, traits_t>::crbegin() const noexcept
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_array<string_t, traits_t>::const_reverse_iterator basic_array<
    string_t, traits_t>::crend() const noexcept
{
    return _array_data.crend();
}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_array<string_t, traits_t>::operator[](size_t pos)
{
    return _array_data[pos];
}

template <typename string_t, typename traits_t>
inline __json_constexpr const basic_value<string_t, traits_t>& basic_array<string_t, traits_t>::operator[](
    size_t pos) const
{
    return _array_data[pos];
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_array<string_t, traits_t> basic_array<string_t, traits_t>::operator+(
    const basic_array<string_t, traits_t>& rhs) const&
{
    basic_array<string_t, traits_t> temp = *this;
...
template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_array<string_t, traits_t>::operator==(
    const basic_array<string_t, traits_t>& rhs) const
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_object<string_t, traits_t>::basic_object(std::initializer_list<value_type> init_list)
    : _object_data(std::make_move_iterator(init_list.begin()), std::make_move_iterator(init_list.end()))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_object<string_t, traits_t>::basic_object(const basic_value<string_t, traits_t>& val)
    : basic_object<string_t, traits_t>(val.as_object())
{}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_object<string_t, traits_t>::basic_object(basic_value<string_t, traits_t>&& val)
    : basic_object<string_t, traits_t>(std::move(val.as_object()))
{}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_object<string_t, traits_t>::contains(const string_t& key) const
{
    return _object_data.find(key) != _object_data.cend();
}

template <typename string_t, typename traits_t>
inline __json_constexpr const basic_value<string_t, traits_t>& basic_object<string_t, traits_t>::at(
    const string_t& key) const
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr void basic_object<string_t, traits_t>::clear() noexcept
{
    _object_data.clear();
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_object<string_t, traits_t>::erase(const string_t& key)
{
    return _object_data.erase(key) > 0 ? true : false;
}

template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_object<string_t, traits_t>::erase(iterator iter)
{
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_object<string_t, traits_t>::emplace(args_t&&... args)
{
    static_assert(std::is_constructible_v<value_type, args_t...>,
...
template <typename string_t, typename traits_t>
template <typename... args_t>
inline __json_constexpr decltype(auto) basic_object<string_t, traits_t>::insert(args_t&&... args)
{
    return emplace(std::forward<args_t>(args)...);
}

template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_object<string_t, traits_t>::to_string() const
{
    string_t str { '{' };
...
template <typename string_t, typename traits_t>
inline __json_constexpr string_t basic_object<string_t, traits_t>::format(size_t indent, size_t indent_times) const
{
    const string_t tail_indent(indent * indent_times, ' ');
    const string_t body_indent(indent * (indent_times + 1), ' ');
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr bool basic_object<string_t, traits_t>::all() const
{
...
template <typename string_t, typename traits_t>
template <typename value_t, template <typename...> typename another_map_t>
inline __json_constexpr another_map_t<string_t, value_t> basic_object<string_t, traits_t>::to_map() const
{
...
template <typename string_t, typename traits_t>
template <typename value_t, typename... rest_keys_t>
inline __json_constexpr auto basic_object<string_t, traits_t>::get_helper(const value_t& default_value,
                                                                          const string_t& key,
                                                                          rest_keys_t&&... rest) const
{
    constexpr bool is_json = std::is_same_v<basic_value<string_t, traits_t>, value_t> ||
...
template <typename string_t, typename traits_t>
template <typename value_t>
inline __json_constexpr std::optional<value_t> basic_object<string_t, traits_t>::find(const string_t& key) const
{
    static_assert(std::is_constructible_v<value_t, basic_value<string_t, traits_t>>,
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_object<string_t, traits_t>::iterator basic_object<string_t,
                                                                                         traits_t>::begin() noexcept
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_object<string_t, traits_t>::const_iterator basic_object<
    string_t, traits_t>::begin() const noexcept
{
    return _object_data.begin();
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_object<string_t, traits_t>::const_iterator basic_object<
    string_t, traits_t>::end() const noexcept
{
    return _object_data.end();
}
...
template <typename string_t, typename traits_t>
inline __json_constexpr typename basic_object<string_t, traits_t>::const_iterator basic_object<
    string_t, traits_t>::cend() const noexcept
{
    return _object_data.cend();
}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_object<string_t, traits_t>::operator[](
    const string_t& key)
{
...
template <typename string_t, typename traits_t>
inline __json_constexpr basic_value<string_t, traits_t>& basic_object<string_t, traits_t>::operator[](string_t&& key)
{
    return _object_data[std::move(key)];
}

template <typename string_t, typename traits_t>
inline __json_constexpr basic_object<string_t, traits_t> basic_object<string_t, traits_t>::operator|(
    const basic_object<string_t, traits_t>& rhs) const&
{
    basic_object<string_t, traits_t> temp = *this;
...
template <typename string_t, typename traits_t>
inline __json_constexpr bool basic_object<string_t, traits_t>::operator==(
    const basic_object<string_t, traits_t>& rhs) const
{
...
template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr std::optional<basic_value<string_t, traits_t>> parser<
    string_t, traits_t, parsing_t, accel_traits>::parse(const parsing_t& content)
{
    return parser<string_t, traits_t, parsing_t, accel_traits>(content.cbegin(), content.cend()).parse();
}

template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr std::optional<basic_value<string_t, traits_t>> parser<string_t, traits_t, parsing_t,
                                                                              accel_traits>::parse()
{
    if (!skip_whitespace()) {
        return std::nullopt;
    ...
    basic_value<string_t, traits_t> result_value;
    switch (*_cur) {
    case '[':
...
template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr basic_value<string_t, traits_t> parser<string_t, traits_t, parsing_t,
                                                               accel_traits>::parse_value()
{
    ...
    case '{':
        return parse_object();
    default:
        return invalid_value<string_t, traits_t>();
    }
}
                                                               ...
                                                               accel_traits>::parse_null()
{
    ...
    return basic_value<string_t, traits_t>();
}
                                                               ...
                                                               accel_traits>::parse_number()
{
    ...
    return basic_value<string_t, traits_t>(basic_value<string_t, traits_t>::value_type::number, string_t(first, _cur));
}
                                                               ...
                                                               accel_traits>::parse_string()
{
    ...
    return basic_value<string_t, traits_t>(basic_value<string_t, traits_t>::value_type::string,
                                                               ...
                                                               accel_traits>::parse_array()
{
    ...
    if (!skip_whitespace()) {
        ...
        ++_cur;
        // empty basic_array
        return basic_array<string_t, traits_t>();
    }

    typename basic_array<string_t, traits_t>::raw_array result;
    while (true) {
        if (!skip_whitespace()) {
            return invalid_value<string_t, traits_t>();
        }

        basic_value<string_t, traits_t> val = parse_value();
    ...
    return basic_array<string_t, traits_t>(std::move(result));
}
                                                               ...
                                                               accel_traits>::parse_object()
{
    ...
    if (!skip_whitespace()) {
        ...
        ++_cur;
        // empty basic_object
        return basic_object<string_t, traits_t>();
    }

    typename basic_object<string_t, traits_t>::raw_object result;
    while (true) {
        if (!skip_whitespace()) {
            return invalid_value<string_t, traits_t>();
        }
    ...
    return basic_object<string_t, traits_t>(std::move(result));
}

template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr std::optional<string_t> parser<string_t, traits_t, parsing_t, accel_traits>::parse_stdstring()
{
    if (*_cur == '"') {
        ++_cur;
    }
...
template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr bool parser<string_t, traits_t, parsing_t, accel_traits>::skip_string_literal_with_accel()
{
...
template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr bool parser<string_t, traits_t, parsing_t, accel_traits>::skip_whitespace() noexcept
{
    while (_cur != _end) {
        switch (*_cur) {
        case ' ':
...
__json_constexpr bool dispatch_is_digit(elem_t ch)
{
#ifdef __json_enable_constexpr
    if (std::is_constant_evaluated()) {
...
template <typename string_t, typename traits_t, typename parsing_t, typename accel_traits>
inline __json_constexpr bool parser<string_t, traits_t, parsing_t, accel_traits>::skip_digit()
{
    // At least one digit
    if (_cur != _end && dispatch_is_digit(*_cur)) {
        ++_cur;
    }
    else {
        return false;
    ...
    while (_cur != _end && dispatch_is_digit(*_cur)) {
        ++_cur;
    }
...
__json_constexpr auto parse(const parsing_t& content)
{
    ...
    return parser<string_t, default_container_traits, parsing_t>::parse(content);
}
...
{
    using string_t = std::basic_string<typename parsing_t::value_type>;
    return parser<string_t, constexpr_container_traits, parsing_t>::parse(content);
}
#endif
...
auto open(const path_t& filepath, bool check_bom)
{
    ...
    using json_t = json::basic_value<string_t, default_container_traits>;
...
template <typename ostream_t, typename string_t, typename traits_t,
...
ostream_t& operator<<(ostream_t& out, const basic_value<string_t, traits_t>& val)
{
    out << val.format();
    return out;
}
...
ostream_t& operator<<(ostream_t& out, const basic_array<string_t, traits_t>& arr)
{
    out << arr.format();
    return out;
}
template <typename ostream_t, typename string_t, typename traits_t,
          ...
          typename enable_t =
              std::enable_if_t<std::is_same_v<std_ostream_t, ostream_t> || std::is_base_of_v<std_ostream_t, ostream_t>>>
ostream_t& operator<<(ostream_t& out, const basic_object<string_t, traits_t>& obj)
{
    out << obj.format();
    return out;
}
...
__json_constexpr const basic_value<string_t, traits_t> invalid_value()
{
    return basic_value<string_t, traits_t>(basic_value<string_t, traits_t>::value_type::invalid,
                                           typename basic_value<string_t, traits_t>::var_t());
}
...
template <bool loose, typename any_t, typename string_t, typename traits_t, typename string_converter_t>
__json_constexpr basic_value<string_t, traits_t> serialize(any_t&& arg, string_converter_t&& string_converter)
{
    using namespace _serialization_helper;

    if constexpr (std::is_constructible_v<basic_value<string_t, traits_t>, any_t>) {
        return basic_value<string_t, traits_t>(std::forward<any_t>(arg));
    }
    else if constexpr (std::is_constructible_v<basic_array<string_t, traits_t>, any_t>) {
        return basic_array<string_t, traits_t>(std::forward<any_t>(arg));
    }
    else if constexpr (std::is_constructible_v<basic_object<string_t, traits_t>, any_t>) {
        return basic_object<string_t, traits_t>(std::forward<any_t>(arg));
    }
        ...
        basic_value<string_t, traits_t> result;
        for (auto&& val : arg) {
