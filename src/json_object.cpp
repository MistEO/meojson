...
json::object::object(const raw_object& raw_obj) : _object_data(raw_obj) { ; }

json::object::object(raw_object&& raw_obj) : _object_data(std::move(raw_obj)) {
  ;
}
...
void json::object::clear() noexcept { _object_data.clear(); }
...
const std::string json::object::format(std::string shift_str,
...
const unsigned long json::object::get(const std::string& key,
...
const long long json::object::get(const std::string& key,
...
const unsigned long long json::object::get(
    const std::string& key, unsigned long long default_value) const {
  if (exist(key)) {
    json::value value = _object_data.at(key);
    if (value.is_number()) {
...
const float json::object::get(const std::string& key,
...
const double json::object::get(const std::string& key,
...
const long double json::object::get(const std::string& key,
...
const std::string json::object::get(const std::string& key,
