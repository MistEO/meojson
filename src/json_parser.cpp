...
std::optional<json::value> json::parser::parse(const std::string& content)
{
...
json::value json::parser::parse_string()
{
    ...
    return json::value(value_type::String, std::move(string_opt).value());
}
...
std::optional<json::value> json::parse(const std::string& content)
{
